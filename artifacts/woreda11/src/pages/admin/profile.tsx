...
export default function AdminProfile() {
  ...
  const initials = (user?.fullName ?? "A").split(" ").map(p => p[0]).join("").toUpperCase().slice(0, 2);
          ...
          <Card>
            ...
            <CardContent className="space-y-5">
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-xs text-muted-foreground">Profile photo via upload</p>
              </div>
              <div>
              ...
              <div>
                ...
                <Input value={user?.username ?? ""} readOnly className="mt-1.5 bg-muted cursor-not-allowed" />
              </div>
